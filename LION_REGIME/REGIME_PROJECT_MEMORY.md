...
0. **Версии боевых ботов.** Промпт говорит «LeonV12 / LION v6.1», Leon говорит: боты v14 и v15. Промпт устарел.
   Уточнить: какой из них проходит FTMO, какая версия стратегии LION в нём, чем v14 отличается от v15.
   Для наложения (шаг 6) нужен список сделок именно того бота, который пойдёт на funded.
